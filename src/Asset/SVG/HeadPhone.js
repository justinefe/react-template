...
const Undo = ({ height, width, className, onClick }) => {
  return (
    <div className={className} onClick={onClick}>
      ...
      >
        <g>
          <g>
            <path
              d='M354.48,144c0-79.529-64.471-144-144-144s-144,64.471-144,144c-20.56,2.56-40,16-40,47.2v75.2c0,35.2,24.64,48,48,48h23.2
